...
/obj/item/card/id/proc/mass_insert_money(list/money, mob/user)
	...
	log_econ("[money] credits were inserted into [src] owned by [src.registered_name]")
	QDEL_LIST(money)
...
/obj/item/card/id/AltClick(mob/living/user)
	...
	if(registered_account.adjust_money(-amount_to_remove))
		...
		log_econ("[amount_to_remove] credits were inserted into [src] owned by [src.registered_name]")
		return
	else
