...
/client/proc/test_dview_to_lum_changes()
	...
	//Print the results
	to_chat(usr, "<span class='notice'>10000 dview calls resulted in a [total_time_dview]ms overhead. ([total_dview] items located)</span>", confidential=TRUE)
	to_chat(usr, "<span class='notice'>10000 lum changes resulted in a [total_time_lum]ms overhead. ([total_lum] items located)</span>", confidential=TRUE)
